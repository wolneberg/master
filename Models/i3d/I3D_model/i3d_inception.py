...
WEIGHTS_PATH_NO_TOP = {
    ...
    'rgb_imagenet_and_kinetics' : 'Models/i3d/I3D_model/rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5',
...
def Inception_Inflated3d(include_top=True,
    ...
    if include_top:
        ...
        x = MaxPooling3D((2, 7, 7), strides=(1, 1, 1), padding='valid', name='global_avg_pool')(x)
