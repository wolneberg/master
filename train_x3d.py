...
def main(args):
    ...
    logging.basicConfig(filename=f'Models/x3d/Output/{name}.log',encoding='utf-8',level=logging.INFO, filemode = 'w', format='%(process)d-%(levelname)s-%(message)s') 
    logging.info("-----------------------------------------")
    logging.info("-----------------------------------------")
    ...
    # to_gif(train_dataset[24][0][0], train_dataset[24][1])
